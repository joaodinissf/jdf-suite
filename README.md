...
| [jdf-tab-huddle](packages/jdf-tab-huddle) | Chrome extension — **Huddle** — for sorting, grouping, and de-duplicating browser tabs | v0.2.2 (pre-release, not yet in Chrome Web Store) | Load unpacked `packages/jdf-tab-huddle/src/` in Chrome |
